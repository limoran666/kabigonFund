...
public class ReturnVO implements Serializable {
    ...
    // 说明图片路径
    private String describPicPa;

    public ReturnVO() {
    }

    public ReturnVO(Integer type, Integer supportmoney, String content, Integer count, Integer signalpurchase, Integer purchase, Integer freight, Integer invoice, Integer returndate, String describPicPa) {
        this.type = type;
        ...
        this.describPicPa = describPicPa;
    }
    ...
    public String getDescribPicPa() {
        return describPicPa;
    }

    public void setDescribPicPa(String describPicPa) {
        this.describPicPa = describPicPa;
    }
}
