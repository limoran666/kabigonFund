        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a href="admin/to/add/save.html" class="btn bg-primary" style="float:right;"><i class="glyphicon glyphicon-plus"></i>新增</a>
                    ...
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <tr>
                                ...
                                <td>${admin.email}</td>
                                <td>
                                    <a href="assign/to/assign/role/page.html?adminId=${admin.id}&pageNum=${requestScope.pageInfo.pageNum}&keyword=${param.keyword}" class="btn btn-success btn-xs"><i class=" glyphiconglyphicon-check"></i></a>
